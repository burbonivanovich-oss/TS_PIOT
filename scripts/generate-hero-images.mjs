...
const CAT_STYLE = {
  ...
  'markirovka':      'wide shot of retail shelves with unlabelled consumer goods, QR code stickers as abstract geometric accents, warm tungsten lighting, editorial atmosphere',
