...
const FONTS_DEF = [
  ...
  },
  {
    ...
    slug: 'rubik',
    pkg: 'rubik',
    note: 'Округлые углы. Узнаваемый, тёплый.',
    regular: 'rubik-cyrillic-400-normal.woff',
    bold:    'rubik-cyrillic-700-normal.woff',
  },
  {
    name: 'Commissioner',
    slug: 'commissioner',
    pkg: 'commissioner',
    note: 'Гуманистический гротеск. Редакционный, элегантный.',
    regular: 'commissioner-cyrillic-400-normal.woff',
    bold:    'commissioner-cyrillic-700-normal.woff',
  },
  {
    name: 'Jost',
    slug: 'jost',
    pkg: 'jost',
    note: 'Геометрический с характером. Близок к Geologica.',
    regular: 'jost-cyrillic-400-normal.woff',
    bold:    'jost-cyrillic-700-normal.woff',
  },
  {
    name: 'Exo 2',
    slug: 'exo-2',
    pkg: 'exo-2',
    note: 'Технологичный. Подходит к теме ТС ПИоТ.',
    regular: 'exo-2-cyrillic-400-normal.woff',
    bold:    'exo-2-cyrillic-700-normal.woff',
  },
];
