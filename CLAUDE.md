...
По умолчанию сайт публикуется **сам**: `content-autopilot.yml` раз в месяц
пишет норму черновиков с расставленными `pubDate`, а `auto-publish.yml`
выпускает по одному в день после шлюза качества. Полное описание контура,
настройки и способы вмешаться — **`docs/autopilot.md`**.
