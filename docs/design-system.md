...
|---|---|---|---|---|
| `ts-piot`         | `#111`     | `#C8F500` (lime)      | `#111`  | `#fff`    |
| `markirovka`      | `#E8175D`  | `#fff`                | `#E8175D` | `#fff`  |
| `zakonodatelstvo` | `#C8F500`  | `#111`                | `#C8F500` | `#111`  |
| `kkt`             | `#111`     | `#C8F500` (lime)      | `#111`  | `#fff`    |
| `egais`           | `#111`     | `#C8F500` (lime)      | `#111`  | `#fff`    |
