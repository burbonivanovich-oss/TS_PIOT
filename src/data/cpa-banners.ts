...
export const PRODUCT_CATALOG: ProductCatalogEntry[] = [
	...
	// ── 6 офферов на регистрации в ОРД: появятся в витрине автоматически,
	//    как только получат erid (рендер витрины фильтруется по erid). ──
	{
		slug: 'kontur-podpis',
		...
		bullets: [
			'КЭП для руководителя и сотрудников',
			'Работа с «Честным знаком» и ЭДО',
			'Доступ к госпорталам и торговым площадкам',
			'Аккредитованный УЦ, выпуск в день обращения',
		],
	...
	},
	{
		...
		bullets: [
			'Оформление и гашение ВСД в «Меркурии»',
			'Работа с ВетИС без установки ПО',
			'Приёмка и продажа подконтрольного товара',
			'Интеграция с товарным учётом',
		],
		clusters: ['egais', 'markirovka'],
	},
	{
	...
	},
	{
		...
		bullets: [
			'Сверка НДС с контрагентами до сдачи декларации',
			'Поиск расхождений в книгах покупок и продаж',
			'Снижение риска требований ФНС',
			'Проверка всех контрагентов в одном окне',
		],
		clusters: ['zakonodatelstvo'],
	},
	{
		...
		bullets: [
			'Оценка риска по 115-ФЗ',
			'Скоринг контрагентов и операций',
			'Проверка по критериям ЦБ',
			'Снижение риска блокировки счёта',
		],
		clusters: ['zakonodatelstvo'],
	},
	{
		...
		bullets: [
			'Счета, акты и договоры в электронном виде',
			'Лёгкий вход в ЭДО',
			'Обмен документами с контрагентами',
			'Для тех, кому Диадок пока избыточен',
		],
		clusters: ['zakonodatelstvo'],
	},
];
