...
const _BANNERS_RAW: Record<string, Omit<CpaBanner, 'erid'>> = {
	...
	// ─── Банковские партнёрки (заготовки) ────────────────────────────────────
	// TODO(банк-партнёрка): подставить реальные партнёрские URL и зарегистрировать
	// креативы в Яндекс.ОРД (scripts/ord-register.mjs → ord-erids.json).
	// Пока ctaHref ведут на лендинги без партнёрского хвоста — это технически
	// рабочая ссылка, но БЕЗ ВЫПЛАТЫ. После регистрации в Т-Банк/Точка/Альфа
	// партнёрках заменить URL и добавить erid.
