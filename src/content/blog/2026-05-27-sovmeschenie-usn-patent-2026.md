...
Совмещение УСН и патентной системы налогообложения (ПСН) разрешено только индивидуальным предпринимателям — это прямо установлено ст. 346.18, п. 8 НК РФ. Организации ПСН не применяют вовсе.
